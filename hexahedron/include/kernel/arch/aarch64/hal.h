/**
 * @file hexahedron/include/kernel/arch/aarch64/hal.h
 * @brief HAL
 * 
 * 
 * @copyright
...
#ifndef KERNEL_ARCH_AARCH64_HAL_H
#define KERNEL_ARCH_AARCH64_HAL_H
...
// !!!: TODO: These are not actually working for aarch64 
