/**
 * @file hexahedron/include/kernel/fs/initrd.h
 * @brief Initial ramdisk (USTAR archive) unpacker
 * 
 * 
 * @copyright
...
#ifndef KERNEL_FS_INITRD_UNPACK_H
#define KERNEL_FS_INITRD_UNPACK_H
