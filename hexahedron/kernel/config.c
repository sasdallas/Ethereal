...
const int __kernel_version_minor = 6;
const int __kernel_version_lower = 3;
...
const int __debugger_wait_time = 5000;  // Wait time (in ms) for the debugger to wait on a packet
